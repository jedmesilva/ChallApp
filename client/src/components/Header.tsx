...
export function Header({
  ...
  return (
    <header className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-6 py-6 safe-area-top relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="flex space-x-4 mb-4">
          <div className="glass-card dark:glass-card-dark rounded-2xl px-4 py-3 flex-1">
            <div className="text-xs text-white/80 mb-1">Match</div>
            <div className="text-2xl font-bold text-white">{currentMatch}%</div>
          </div>
          <div className="glass-card dark:glass-card-dark rounded-2xl px-4 py-3 flex-1">
